...
const (
	...
	BalanceService_Deposit_FullMethodName               = "/balance.v1.BalanceService/Deposit"
	BalanceService_GetTransactionHistory_FullMethodName = "/balance.v1.BalanceService/GetTransactionHistory"
)
...
func (c *balanceServiceClient) GetTransactionHistory(ctx context.Context, in *GetTransactionHistoryRequest, opts ...grpc.CallOption) (*GetTransactionHistoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, BalanceService_GetTransactionHistory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BalanceService_GetTransactionHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BalanceService_GetTransactionHistory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

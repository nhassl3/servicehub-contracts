...
const (
	...
	CartService_UpdateItemQty_FullMethodName = "/cart.v1.CartService/UpdateItemQty"
...
func (c *cartServiceClient) UpdateItemQty(ctx context.Context, in *UpdateItemQtyRequest, opts ...grpc.CallOption) (*UpdateItemQtyResponse, error) {
	...
	err := c.cc.Invoke(ctx, CartService_UpdateItemQty_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCartServiceServer) UpdateItemQty(context.Context, *UpdateItemQtyRequest) (*UpdateItemQtyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateItemQty not implemented")
}
...
func _CartService_UpdateItemQty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CartService_UpdateItemQty_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

...
const (
	...
	NotificationService_ApproveCode_FullMethodName        = "/notification.v1.NotificationService/ApproveCode"
)
...
func (c *notificationServiceClient) ListNotification(ctx context.Context, in *ListNotificationRequest, opts ...grpc.CallOption) (*ListNotificationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListNotificationResponse)
	err := c.cc.Invoke(ctx, NotificationService_ListNotification_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notificationServiceClient) ApproveCode(ctx context.Context, in *ApproveCodeRequest, opts ...grpc.CallOption) (*ApproveCodeResponse, error) {
	...
	err := c.cc.Invoke(ctx, NotificationService_ApproveCode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedNotificationServiceServer) ListNotification(context.Context, *ListNotificationRequest) (*ListNotificationResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListNotification not implemented")
}
...
func _NotificationService_ApproveCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotificationService_ApproveCode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
